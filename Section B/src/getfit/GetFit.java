...
public class GetFit {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, status);
         ...
         Workouts[] workouts = new Workouts[10]; 
        int count = 0;
        int choice;
        ...
        do {
            ...
            switch (choice) {
                case 1: // Running
                    ...
                    workouts[count++] = new Running(rDate, rDuration, distance);
                    break;
                ...
                case 2: // Cycling
                    ...
                    workouts[count++] = new Cycling(cDate, cDuration, cDistance);
                    break;
                ...
                case 3: // Swimming
                    ...
                    workouts[count++] = new Swimming(sDate, sDuration, laps);
                    break;
                ...
                case 4: // Weight Lifting
                    ...
                    workouts[count++] = new Lifting(wDate, wDuration, sets);
                    break;
                ...
                case 5: // Report
                    ...
                    for (int i = 0; i < count; i++) {
                        report.append(workouts[i]).append("\n");
                        totalCalories += workouts[i].calculateCaloriesBurned();
                    }
